...
# Create admin user. Generate password if there isn't one in the environment variables. Password is not printed to log, but needs to be changed at the pod command line
